          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-600 dark:text-green-500">
              ...
              <li className="flex items-center gap-2 hover:text-green-300 transition-colors">
                ...
                <span>
                  <Link
                    href="https://www.google.com/maps?q=40.029889,-6.090175"
                    target="_blank"
              ...
              <li className="flex items-center gap-2 hover:text-green-300 transition-colors">
                ...
                <a href="tel:+34927000000" className="hover:underline">
                  +34 927 00 00 00
                </a>
              </li>
              ...
              <li className="flex items-center gap-2 hover:text-green-300 transition-colors">
                ...
                <a href="mailto:contacto@tienda.es" className="hover:underline">
                  contacto@tienda.es
                </a>
              </li>
            </ul>
